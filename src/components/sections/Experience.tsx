...
export const Experience = () => {
  ...
  return (
    <section
      ref={containerRef}
      id="experience"
      className="min-h-screen relative bg-[#080807] text-[#D1D1C7] rounded-t-[2rem] px-4 sm:px-8 lg:px-16 py-16"
    >
      <h2 className="sticky top-2 z-30 font-inconsolata font-bold text-[4rem] sm:text-[6rem] lg:text-[8rem] uppercase leading-[1] bg-[#080807] pb-[.5em]">
        Experience
      </h2>
      ...
      {EXPERIENCE.map((exp, idx) => (
        <div
          key={idx}
          className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-8 border-t border-gray-700 mb-8 px-4 lg:px-8 pt-3 pb-3"
        >
          {/* Desktop: Period */}
          ...
          <div className="sm:col-span-3 sm:px-12">
            <h3 className="text-3xl lg:text-5xl font-bold mb-1">{exp.role}</h3>
