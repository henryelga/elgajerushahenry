...
export const Skills = () => {
  ...
  return (
    ...
    >
      {/* Heading */}
      <h2 className="sticky top-0 z-30 font-inconsolata font-bold text-[6rem] lg:text-[8rem] uppercase leading-[1] bg-[#080807] pb-4">
        Skills
      </h2>

      {/* Skills Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mt-16 max-w-7xl mx-auto">
        {Object.entries(SKILLS).map(([category, skillList], idx) => (
          <div key={idx} className="flex flex-col space-y-1">
            {/* Category title */}
            <h3
              className="text-xl lg:text-2xl font-bold border-b border-gray-700 cursor-pointer lg:cursor-auto flex justify-between items-center"
            ...
            <ul
              className={`overflow-hidden transition-all duration-500 ease-in-out
                ${!openCategories[category] && "max-h-0 lg:max-h-none"} 
              `}
            >
