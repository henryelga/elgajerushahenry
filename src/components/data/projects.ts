 ...
 *
 * Each object contains title, image path, description, type, and link.
 * Used to display project cards with hover effects and clickable links.
 */
export const PROJECTS = [
  ...
  },
  {
    ...
    image: "images/smartLightSystem.png",
